<nav x-data="{ open: false }" class="bg-slate-100 dark:bg-gray-800 border-b border-slate-200 dark:border-gray-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logo-medicina.png') }}" alt="Logo Medicina App"
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div x-data="{ 
                    ...
                    <button @click="toggleTheme()"
                        ...
                        <svg x-show="isDark" style="display: none;" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
